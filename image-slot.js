...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 Cairo,system-ui,-apple-system,sans-serif;' +
    ...
    '  background:rgba(0,0,0,.65);color:#fff;font:11px/1 Cairo,system-ui,-apple-system,sans-serif;' +
    ...
    '  font:10px/1.2 Cairo,system-ui,-apple-system,sans-serif;text-decoration:none;' +
    ...
    '  font:13px/1.45 Cairo,system-ui,-apple-system,sans-serif}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">أو <u>اختر ملفًا</u></div></div>' +
        '  <div class="attr-error" part="attribution-error">' + warnIcon +
        '    <div class="cap">هذه الصورة تحتاج نسبة مصدر</div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="استبدال الصورة">استبدال</button>' +
        '  <button data-act="edit" title="تعديل الإطار">تعديل</button></div>' +
